public class ShapeT implements Tetromino {
    ...
    public ShapeT() {
        ...
        blocks[1] = new Block(xArr, yArr + 1, r, g, b);
        blocks[2] = new Block(xArr + 1, yArr, r, g, b);
    ...
    */
    public void setBlocks() {
        if (rot == 0) {
            ...
            blocks[2].setArr(xArr + 1, yArr);
            blocks[3].setArr(xArr - 1, yArr);
        } else if (rot == 1) {
            blocks[0].setArr(xArr, yArr);
            blocks[1].setArr(xArr, yArr + 1);
            blocks[2].setArr(xArr + 1, yArr);
            blocks[3].setArr(xArr, yArr - 1);
        } else if (rot == 2) {
            blocks[0].setArr(xArr, yArr);
            blocks[1].setArr(xArr, yArr - 1);
            blocks[2].setArr(xArr + 1, yArr);
