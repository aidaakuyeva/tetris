...
public class ShapeS implements Tetromino {
    ...
    public ShapeS() {
        ...
        this.yArr = 19;
        this.moving = true;
        blocks[0] = new Block(xArr, yArr, r, g, b);
        blocks[1] = new Block(xArr + 1, yArr, r, g, b);
        blocks[2] = new Block(xArr, yArr - 1, r, g, b);
        blocks[3] = new Block(xArr - 1, yArr - 1, r, g, b);
    }
